...
const size_t plainTextSize = 256;  // Definir tamaño explícitamente (Se recomienda usar textos planos de mas de 128 bytes)
...
void setup() {
  ...
  for (int i = 0; i < 100; i++) {
    ...
    chacha20.chacha20_encrypt(key, nonce, counter, plainText, plainTextSize, cipherText);
  ...
  float avgEncrypt = totalEncryptTime / 100.0;
  float avgDecrypt = totalDecryptTime / 100.0;
