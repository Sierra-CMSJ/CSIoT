...
void setup() {
  ...
  uint8_t plainText[plainTextSize] = { 0x43, 0x72, 0x69, 0x70, 0x74, 0x6F, 0x67, 0x72, 0x61, 0x66, 0x69, 0x61, 0x31, 0x32, 0x33, 0x34};                             //Cambiar plainTextSize = 16;  
  ...
  */
  ...
  /*
  uint8_t plainText[plainTextSize] = {  
  0xC5, 0xB0, 0xE7, 0xAE, 0xAB, 0x5A, 0x9A, 0x1C, 0xB3, 0xF2, 0x81, 0x2A, 0x15, 0xAB, 0xD0, 0xE2,                             //Cambiar plainTextSize = 512;
  ...
  */
  ...
  aes.encryptCBC(plainText, plainTextSize, expandedKey, keySize, iv, cipherText);
